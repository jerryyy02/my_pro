package com.cts.my_project.configuration;
...
@ComponentScans(value = { @ComponentScan("com.cts.my_project.dao"),
      @ComponentScan("com.cts.my_project.service") })
public class AppConfig {
   ...
   public LocalSessionFactoryBean getSessionFactory() {
      ...
      factoryBean.setPackagesToScan("com.cts.my_project.bean");
      return factoryBean;
   }
